...
const styles = StyleSheet.create({
    ...
    ratingBadge: { backgroundColor: THEME.gold, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 8 },
    ratingText: { fontSize: 10, fontWeight: 'bold', color: THEME.navy },
    locationText: { fontSize: 12, color: 'rgba(255, 255, 255, 0.5)', marginBottom: 4 },
    credentialBadge: { backgroundColor: THEME.gold, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, alignSelf: 'flex-start', marginTop: 4 },
    credentialText: { fontSize: 9, fontWeight: 'bold', color: THEME.navy, textTransform: 'uppercase' },
